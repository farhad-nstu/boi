...
<main id="tg-main" class="tg-main tg-haslayout">
			...
			<section class="tg-dbsectionspace tg-haslayout">
				<div class="row">
					<form class="tg-formtheme tg-formdashboard" action="{{ route('new-book')}}" method="post" enctype="multipart/form-data" onsubmit="return checkForm(this);">
                        @csrf
						<fieldset>
...
<!--                                            Book Category ID-->
                                            ...
                                            <div class="form-group">
												...
												<textarea id="tg-tinymceeditor" name="book_details" class="tg-tinymceeditor"></textarea>
											</div>
								...
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-5">
									...
									<div class="tg-dashboardbox tg-contactdetail">
                                        ...
                                        <div class="form-group">
                                              <input id="tags_1" type="text" name="book_tag_names" class="tags form-control" value="" />
											  ...
											  <div class="form-group">
												...
												<div class="tg-selectgroup">
													<span class="tg-radio">
														<input id="tg-sameuser" type="radio" name="status" value="1" checked>
														<label for="tg-sameuser">Active</label>
													</span>
													<span class="tg-radio">
														<input id="tg-someoneelse" type="radio" name="status" value="0">
