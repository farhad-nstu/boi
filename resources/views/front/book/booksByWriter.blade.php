...
@section('title')
    {{ $writer->writer_name }} Books | BoiChakra
@endsection
                    ...
                    <div class="col-xs-12 col-sm-7 col-md-8 col-lg-9">
                        <div style="height:  200px; background-color: black; ">
                            ...
                            @if($writer->writer_image)
                                    <img class="img-circle" style="margin-top: 20px; margin-left: 10px; height: 150px; width: 150px;" src="{{ asset($writer->writer_image) }}" alt="image description">
                                @else
                            ...
                            <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                                <h3 style="color: white">{{ $writer->writer_name }}</h3>
                                <span style="color: white; margin-top: 20px;">{{ $writer->writer_details }}</span>
                            </div>
                        </div>
                        ...
                        <div id="tg-content" class="tg-content">
                            <div class="tg-contenthead">
                                <ul class="tg-pagesequence">
                                    ...
                                    <li><a href="{{ route('writers') }}">Writer</a></li>
                                    <li><span>{{ $writer->writer_name }}</span></li>
                                </ul>
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                        <div class="tg-pagehead" style="padding: 0 0 0px;">
                                            <h3 >Books of {{ $writer->writer_name }}</h3>
                                            <p >{{ \App\Book::where('writer_id', $writer->id)->count() }} Results on {{ \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', today())->format('M d, Y') }}</p>
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
