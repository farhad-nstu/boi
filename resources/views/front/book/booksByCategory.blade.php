...
@section('title')
    {{ $category->book_category_name }} Books | BoiChakra
@endsection
                        ...
                        <div id="tg-content" class="tg-content">
                            <div class="tg-contenthead">
                                <ul class="tg-pagesequence">
                                    ...
                                    <li><span>{{ $category->book_category_name }}</span></li>
                                </ul>
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                        <div class="tg-pagehead" style="padding: 0 0 0px;">
                                            <h3 >Books of {{ $category->book_category_name }}</h3>
                                            <p >{{ \App\Book::where('book_category_id', $category->id)->count() }} Results on {{ \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', today())->format('M d, Y') }}</p>
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
